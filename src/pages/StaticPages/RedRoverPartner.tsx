    ...
    <>
      ...
      <Container maxWidth="md" sx={{ mt: 10 }}>
        ...
        <Grid container spacing={4} sx={{ display: "flex", justifyContent: "center", alignItems: "center", mb: 6, }}>
          <Grid item xs={12}>
            <Box sx={{ backgroundColor: "#F5ECEF", px: 2, py: 2, mt: 4, mb: 4 }}>
              <Typography variant="body1" sx={{ fontWeight: 500, fontSize: '1.125rem', textAlign: "center", lineHeight: 1.5 }}>
          ...
          <Grid item xs={12}>
            ...
            <Typography variant="body1" sx={{ fontWeight: 500, textAlign: "left", lineHeight: 2, '& a': { color: '#940940' } }}>
