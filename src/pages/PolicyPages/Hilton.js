...
export default function Hilton() {
	return (<>
		...
		<Box sx={{ maxWidth: '760px', mx: 'auto', pb: '1rem' }}>
			...
			<Typography variant="p">Hilton&apos;s pet policy allows guests to bring their pets to select hotels within the Hilton portfolio. Dogs and cats are the most common types of pets allowed, although some hotels may allow other types of animals as well. There is typically a non-refundable fee associated with bringing a pet, which can range from $50 to $150 per stay. Some hotels may also have restrictions on the size or breed of pet allowed, so it&apos;s important to check with the hotel in advance.</Typography>
			...
			<Typography variant="p">Hilton makes it easy to find pet-friendly rooms by using the Romingo website or app. Just enter your destination and dates, and the site will show you all of the pet-friendly hotels in the area. You can then book your room directly through Romingo or by visiting the Hilton website.</Typography>

			<Typography mt="2rem" mb="0.5rem" variant="h4">What to Expect When Traveling with Pets to Hilton Hotels</Typography>
			<Typography variant="p">When traveling with pets to Hilton hotels, you should always prepare in advance. Be sure to pack any necessary items for your pet, such as food, water, bowls, toys, and a crate if needed. You should also bring along any medical records and proof of vaccinations. To ensure a comfortable stay for both you and your pet, consider booking a pet-friendly room with easy access to outdoor areas for walking and exercise.</Typography>
			...
			<Typography variant="p">Hilton hotels accept cats and dogs up to a certain weight limit. Of course, service animals are allowed at all of their properties without any restrictions or fees. Some Hilton brands may also permit other types of animals, such as birds and fish, so it is best to check with the individual hotel for specific requirements.</Typography>

			<Typography mt="2rem" mb="0.5rem" variant="h4">Fees and Restrictions Associated With Bringing Pets to Hilton Hotels</Typography>
			<Typography variant="p">Some Hilton hotels may charge a fee for bringing a pet with you. The fees vary by property, so it is important to check your reservation details before making your travel plans. Most properties will also limit the number of pets allowed in any single room and require that animals remain on a leash when in public areas.</Typography>
