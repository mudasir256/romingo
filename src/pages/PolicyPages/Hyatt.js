...
export default function Hyatt() {
	...
	return (<>
		...
		<Box sx={{ maxWidth: '760px', mx: 'auto', pb: '1rem', px: '1rem' }}>
			...
			<Typography variant="base">1. <b>Hyatt Place</b>: Hyatt Place is a great option for travelers with pets, as most of their locations allow pets. They have a relaxed and comfortable atmosphere, perfect for travelers and their pets.</Typography>
			<Typography variant="base">2. <b>Hyatt House</b>: Hyatt House also allows pets at most of their locations. Their suites provide a spacious and homely feel, making it easy for you and your pet to feel at home.</Typography>
			<Typography variant="base">3. <b>Andaz</b>: Andaz hotels are known for their stylish and chic atmosphere, and many of their locations welcome pets. Your pet will enjoy the luxurious amenities and you will enjoy the stylish decor.</Typography>
			<Typography variant="base">4. <b>The Unbound Collection by Hyatt</b>: The Unbound Collection by Hyatt features a range of unique and independent hotels, each with their own distinct style. Many of these properties allow pets, and offer a more personalized experience for you and your furry friend.</Typography>
			<Typography variant="base">To find a pet-friendly Hyatt hotel, check out the Hyatt website or use Romingo, a premier resource for booking pet-friendly hotels. When booking your stay, be sure to check the specific pet policies for that location.</Typography>
			...
			<ul>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>Hyatt hotels welcome pets with open arms, providing an exceptional experience for both pets and their owners.</li>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>Upon arrival, expect a warm welcome for both you and your furry friend.</li>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>Hyatt hotels provide comfortable accommodations for pets, including cozy beds and feeding bowls.</li>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>Many Hyatt hotels offer outdoor areas for pets to play and stretch their legs.</li>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>Some Hyatt hotels may provide special treats or amenities for your pet, so be sure to ask at check-in.</li>
			</ul>
			...
			<ul>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>Make sure your pet is up-to-date on their vaccinations and bring along proof of vaccinations, just in case.</li>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>Pack your pet&apos;s favorite toys, bedding, and food to ensure they feel at home in their new surroundings.</li>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>If your pet is anxious or prone to car sickness, speak to your vet about any medications that may be helpful.</li>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>Bring a collar and leash for your pet, and ensure they wear an identification tag with your current contact information.</li>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>Familiarize yourself with the hotel&apos;s pet policy and any fees or restrictions associated with bringing your pet.</li>
			</ul>
			...
			<ul>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>Create a comfortable space for your pet in the hotel room, with their own bed and water and food bowls.</li>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>Take your pet for regular walks to stretch their legs and get some exercise.</li>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>If your pet is anxious or stressed, spend some extra time with them to help them feel more comfortable in their new environment.</li>
				<li style={{ marginBottom: '0.5rem', fontSize: '1rem'}}>Be respectful of other guests at the hotel, and keep your pet on a leash in common areas.</li>
