...
const SanFrancisco: FC = () => {
  ...
  const la = cityList.find(city => city.name === 'San Francisco, CA')
  ...
  return (
    <>
      <Helmet>
        <title>San Francisco Hotels - Romingo</title>
      </Helmet>
      <ScrollToTop />
      <Navbar />
      <Box
      ...
      <Container maxWidth="md">
       ...
       {/*   <Hidden mdDown>
          ...
          <Grid item xs={12}>
            <Typography sx={{fontFamily: 'sansita-light', fontSize: '2em', ml: '0.25em' }}>Explore San Francisco Hotels</Typography>
