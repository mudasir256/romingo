  ...
  return <>
    ...
    <Container maxWidth="md">
      ...
      >
        ...
        <Grid my='0.5rem' item xs={12} md={12}>
          <Typography
            variant="body1"
            color="text.secondary"
            sx={{ textAlign: "justify", lineHeight: 2 }}
          >
            Beyond the hotel scene, New York City boasts a plethora of pet-friendly parks, including Central Park, where dogs can roam freely in designated areas and enjoy the lush greenery alongside their owners. Additionally, numerous pet-friendly cafes and restaurants offer delightful treats and meals for both humans and pets to indulge in together. Whether strolling through bustling streets or experiencing the city&apos;s iconic landmarks, pet owners can embrace a true sense of inclusivity and camaraderie with their beloved pets by their side in this pet-friendly paradise that is New York City.
          </Typography>
        </Grid>
        ...
        >
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/New%20York/image16.png" text="Central Park" />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/New%20York/image9.png" text="NYC Tourism" />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/New%20York/image2.png" text="High Line" />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/New%20York/image19.png" text="CNN" />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/New%20York/image8.png" text="Klook" />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/New%20York/image6.png" text="Bryant Park" />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/New%20York/image7.png" text="The Wilson" />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/New%20York/image1.png" text="The Standard Biergarten" />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/New%20York/image11.png" text="Freemans" />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/New%20York/image10.png" text="Bistro Chat Noir" />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/New%20York/image18.png" text="Clinton Hall" />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/New%20York/image15.png" text="Threes Brewing" />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/New%20York/image3.png" text="Pig Beach BBQ" />
