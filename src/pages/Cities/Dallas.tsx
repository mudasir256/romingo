    ...
    <Container maxWidth="md">
      ...
      >
        ...
        <Grid mt="2rem" item xs={12} sx={{ mb: 1 }}>
          ...
          <Hidden mdUp>
            <FilterBar city={dallasSearchData} />
          </Hidden>{' '}
        ...
        >
          ...
          <Bold text="The Joule" />
          <SingleLoadListingCard hotelName="100433288" />
          ...
          <SingleLoadListingCard hotelName="100429852" />
          ...
          <SingleLoadListingCard hotelName="100400682" />
          ...
          <SingleLoadListingCard hotelName="101034230" />
          ...
          <SingleLoadListingCard hotelName="100393682" />
          ...
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/Dallas/image4.png"
            text="Dallas Farmers Market"
          />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/Dallas/image9.png"
            text="Deep Ellum Brewing Company"
          />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/Dallas/image2.png"
            text="Trinity River Audubon Center"
          />
          ...
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/Dallas/image8.png"
            text="Truck Yard"
          />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/Dallas/image1.png"
            text="Cane Rosso"
          />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/Dallas/image3.png"
            text="The Porch"
          />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/Dallas/image15.png"
            text="TEN50 BBQ"
          />
          ...
          />
          <Img src="https://storage.googleapis.com/romingo-production-public/destination%20images/Dallas/image17.png"
            text="Outfit Brewing"
          />
