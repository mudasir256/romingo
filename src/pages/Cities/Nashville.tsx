...
const carouselOneData = [
  ...
  {
    src: 'https://storage.googleapis.com/romingo-production-public/destination%20images/Minneapolis/image12.png',
  ...
  {
    src: 'https://storage.googleapis.com/romingo-production-public/destination%20images/Minneapolis/image18.png',
...
const carouselTwoData = [
  ...
  {
    src: 'https://storage.googleapis.com/romingo-production-public/destination%20images/Minneapolis/image5.png',
  ...
  {
    src: 'https://storage.googleapis.com/romingo-production-public/destination%20images/Minneapolis/image19.png',
